...
const SigninButtons = () => {
    return (
        <>
            <button className="bg-gray-100 hover:bg-gray-200 text-black font-semibold py-3 px-4 rounded-lg flex items-center space-x-2 shadow-sm transition">
                <Image src={"/g-logo.svg"} alt={"Google Logo"} height={20} width={20} className="mr-2" />
                Sign in with Google
            </button>

            <button className=" bg-gray-700 hover:bg-gray-800 text-white font-semibold py-3 px-4 rounded-lg flex items-center justify-center space-x-2 shadow-sm transition">
                <svg
